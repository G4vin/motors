	<li class="about">
					<p>projectworlds team is an organized company that rents cars and other vehicles to clients at lower costs.</p>
					<ul>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by <a href= "http://projectworlds.in/">Gavin Ochira.</a>
		</div>
	</footer><!--  end footer  -->
